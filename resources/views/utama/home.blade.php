    ...
    <section id="services" class="services section-bg">
      <div class="container" data-aos="fade-up">
        ...
        <div class="section-title">
          <h2>Ketentuan</h2>
          <p>Untuk dapat mengajukan pengajuan barang dan jasa, Peserta harus sesuai kualifikasi berikut:</p>
        </div>
        ...
        <div class="row">
          <div class="col-xl-3 col-md-6 d-flex align-items-stretch" data-aos="zoom-in" data-aos-delay="100">
            <div class="icon-box">
              ...
              <h4><a href="">Memiliki Ijin Usaha</a></h4>
              <p>Bagi Peserta yang ingin mengajukan pengajuan, wajib terdaftar atau memiliki usaha</p>
            </div>
          </div>
          ...
          <div class="col-xl-3 col-md-6 d-flex align-items-stretch mt-4 mt-md-0" data-aos="zoom-in" data-aos-delay="200">
            <div class="icon-box">
              ...
              <p>Bagi Kamu yang memiliki usaha lebih atau sama dengan 3 tahun, dapat mengajukan pengajuan</p>
            </div>
          </div>
    ...
    <section id="portfolio" class="portfolio">
      <div class="container" data-aos="fade-up">
        ...
        <div class="section-title">
          ...
          <p>Berikut Daftar Pengadaan yang Sedang Aktif</p>
        </div>
