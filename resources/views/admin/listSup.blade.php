                ...
                <table class="table table-hover text-nowrap">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td>
                        @if($sup->status == "0")
                        <a href="/aktif/{{$sup->id_supplier}}" class="btn btn-success konfirmasi"><i class="fa fa-check"></i> Verifikasi</a>
                        @else
                        <a href="/nonAktif/{{$sup->id_supplier}}" class="btn btn-danger konfirmasi"><i class="fa fa-times"></i> Non Aktif</a>
                        @endif
                      </td>                                                                
                    </tr>
                    @endforeach
