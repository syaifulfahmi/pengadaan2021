                ...
                <table class="table table-hover text-nowrap text-center">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td><a href="{{asset(Storage::url($p['laporan']))}}"class="btn btn-warning" target="_blank"><i class="fa fa-eye"></i> Lihat Laporan</a></td>
                    </tr>
                    @endforeach                    
                  </tbody>
                </table>
...
<script type="text/javascript">
  $(document).on("click", ".konfirmasi", function(event){
    ...
    var answer = window.confirm("Apakah Yakin Ingin Memproses Data?");
